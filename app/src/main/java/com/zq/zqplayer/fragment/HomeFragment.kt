    ...
    override fun initData(view: View, savedInstanceState: Bundle?) {
        ...
        mSurfaceview.holder.addCallback(object : SurfaceHolder.Callback {
            ...
            override fun surfaceDestroyed(surfaceHolder: SurfaceHolder) {
                mSurfaceHolder = null
                Toast.makeText(context, "surfaceDestroyed 1", Toast.LENGTH_SHORT).show()
            }
        })
        ...
        mSurfaceviewFilter.holder.addCallback(object : SurfaceHolder.Callback {
            ...
            override fun surfaceDestroyed(surfaceHolder: SurfaceHolder) {
                ...
                Toast.makeText(context, "surfaceDestroyed 2", Toast.LENGTH_SHORT).show()
            }
        })
    }
...
//            Thread(Runnable { player?.play(mSurfaceHolder!!.surface, mSurfaceHolderFilter!!.surface, videoPath, 1) }).start()
    ...
    private fun initData() {
        videoPath = getDataDirPath(this!!.context!!, "meidacodec") + File.separator + "gao_bai_qi_qiu.mp4"
